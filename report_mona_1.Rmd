...
Rprof(NULL)
Rprof(filename="mona_bfastmonitor_1.out",interval=0.005,line.profiling = F)
mona <- bfastmonitor(NDVIa, start = c(2010, 13), history = "all", type ="OLS-MOSUM")
Rprof(NULL)
res = summaryRprof("mona_bfastmonitor_1.out")
res$by.total
#plot(mona)
```
